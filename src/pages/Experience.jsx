...
function Experience() {
  ...
  return (
    <div className="w-screen items-center justify-center p-6 bg-gray-100">
      <div className='flex items-center space-y-10 justify-center flex-col divide-y divide-gray-300'>{
